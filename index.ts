...
(function () {
    ...
    const init = () => {
        ...
        moonCanvas.style.left = BODY_BORDER + 'px'
        moonCanvas.style.top = BODY_BORDER + ((world.height - moon.height) * scale) + 'px'
        ...
        timerElem.style.left = (BODY_BORDER + ((world.width - 120 + SPREAD) * scale)) + 'px'
        timerElem.style.top = (BODY_BORDER + ((world.height - 56) * scale)) + 'px'
    ...
    celestialAnimationElem.addEventListener('click', () => {
        ...
        if (scale === 1) {
            ...
            scale = 1
            celestialAnimationElem.style.height = (world.height) + 'px'
            celestialAnimationElem.style.top = '0px'
            redraw()
        }
    })
